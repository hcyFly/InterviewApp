...
public class HttpBody {
    ...
    private String fileSaveDir = MyApplication.saveDriPath == null ? "/sdcard/download" : MyApplication.saveDriPath;
    ...
    public String getFileSaveDir() {
         KLog.i("MyApplication", "HttpBody defaut save dir path:" + fileSaveDir);
        return fileSaveDir;
    }
    ...
    public String getIsAddToken() {
        return isAddToken;
    }

    public HttpBody setIsAddToken(String isAddToken) {
